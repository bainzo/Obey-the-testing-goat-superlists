...
class NewVisitorTest(LiveServerTestCase):
    ...
    # We will be using 'Edith' as our user for this story...
    def test_can_start_a_list_and_retrieve_it_later(self):
        # Edit has heard about a cool new online to-do app. She goes to
        ...
        # she sees that the site has generated a unique URL for here
